---
name: pos-styling
description: Strict protocols for implementing consistent, professional UI using the platformOS Common Styling module
---

---
# platformOS Common Styling Skill

## Overview

This skill provides **absolute, non-negotiable protocols** for implementing the platformOS Common Styling module. YOU MUST follow every instruction precisely. Consistent styling across platformOS applications is not optional—it ensures accessibility, maintainability, and professional quality.
...
**SUPPORT FILE:** For complete component reference, CSS classes, and code examples, see `./platformos-style-guide.md`
...
<head>
  ...
  <meta name="description" content="{{ page.metadata.description | default: 'platformOS Application' }}">
