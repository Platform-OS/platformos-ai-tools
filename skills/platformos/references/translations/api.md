...
```bash
pos-cli translations list staging
```
...
```bash
pos-cli translations languages staging
```
...
```bash
pos-cli translations validate staging
```
...
```bash
pos-cli translations export en staging --output en.yml
```
...
```bash
pos-cli translations import staging --file de.yml
```
