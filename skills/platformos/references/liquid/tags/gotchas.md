# platformOS Liquid Tags: Common Gotchas & Troubleshooting
...
Alternative: Use the function without explicit return (platformOS will return the last assigned variable):
