...
description: Expansion module for implementing roles, permissions, and authorization in platformOS
---
...
platformOS implements authorization through three interconnected elements:
...
platformOS automatically prioritizes `app/` over `modules/`.
...
1. Deploy changes: `pos-cli deploy staging`
...
1. Run `pos-cli gui serve staging`
...
pos-cli test run staging test/auth/authorization_test
