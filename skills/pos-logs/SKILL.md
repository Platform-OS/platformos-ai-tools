---
name: pos-logs
description: Fetch and analyze platformOS logs for errors and debugging
---

# PlatformOS Log Analyzer

Fetch and analyze logs from platformOS instance.
...
**Fix:** Use only documented platformOS tags
