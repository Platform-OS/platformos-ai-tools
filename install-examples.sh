...
REPO_URL="https://github.com/Platform-OS/platformos-ai-tools"
...
Examples:
  ...
  curl -fsSL https://raw.githubusercontent.com/Platform-OS/platformos-ai-tools/master/install-examples.sh | bash -s -- --claude --global
EOF
}
